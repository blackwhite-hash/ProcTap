...
ProcessAudioTap is a Python library with a high-performance C++ backend that enables
per-process audio capture on Windows 10/11 (20H1+) using ActivateAudioInterfaceAsync.
